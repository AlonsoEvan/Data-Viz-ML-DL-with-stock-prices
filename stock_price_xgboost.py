...
df['EMA_9'] = df[price].ewm(9).mean().shift(1).astype(np.float32)
df['SMA_5'] = df[price].rolling(5).mean().shift(1).astype(np.float32)
df['SMA_10'] = df[price].rolling(10).mean().shift(1).astype(np.float32)
df['SMA_15'] = df[price].rolling(15).mean().shift(1).astype(np.float32)
df['SMA_30'] = df[price].rolling(30).mean().shift(1).astype(np.float32)
...
train_df = train_df[[price, 'EMA_9', 'SMA_5', 'SMA_10', 'SMA_15', 'SMA_30', 'RSI', 'month', 'week', 'day', 'day_of_week']]
valid_df = valid_df[[price, 'EMA_9', 'SMA_5', 'SMA_10', 'SMA_15', 'SMA_30', 'RSI', 'month', 'week', 'day', 'day_of_week']]
test_df = test_df[[price, 'EMA_9', 'SMA_5', 'SMA_10', 'SMA_15', 'SMA_30', 'RSI', 'month', 'week', 'day', 'day_of_week']]
